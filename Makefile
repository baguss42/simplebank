...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/baguss42/simplebank/db/sqlc Store

#example create migration file
# simplebank % migrate create -ext  sql -dir db/migration -seq add_users
