...
// Source: github.com/baguss42/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 db.TransferTrxParams) (db.TransferTrxResult, error) {
	m.ctrl.T.Helper()
